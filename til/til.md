...
<div class="image-grid">
    <img src="assets/images/rendered-cylinder.png" alt="rendered cylinder">
    <img src="/assets/images/rendered-cone.png" alt="rendered cone">
    <img src="/assets/images/rendered-arrow.png" alt="rendered arrow">
</div>

**Rasterization of a plane:** Well, I also tried to rasterize a plane to represent some sort of reference surface but my frame rate droped around 5-10 FPS probably because of working with lots of triangles & pixels. So, I decided to do the same with grid lines but well it was even worse now because there was no clipping implemented for lines 🙁 and the projected vertices in screen space were just two big specially the ones near camera (probably in range of millions of pixel wide because $z \to 0$). So, the obvious thing remains. I have to implement clipping for lines.
